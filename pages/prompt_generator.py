...
4. Final Check
   ...
   - Output preparation"""
        ...
        default_output_content = st.session_state.get('selected_output_formats_1', 'Not Generated...') if version == "Solution A" else (st.session_state.get('selected_output_formats_2', 'Not Generated...') if version == "Solution B" else st.session_state.get('selected_output_formats_3', 'Not Generated...'))
        st.text_area(
